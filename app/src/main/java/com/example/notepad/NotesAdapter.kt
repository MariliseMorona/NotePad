...
class NotesAdapter(private val listener: NoteClickedListener): RecyclerView.Adapter<>(){
...
class NotesViewHolder(itemView: View?):RecyclerView.ViewHolder(itemView!!) {
    ...
    var noteButtonRemove = itemView.findViewById(R.id.btn_noteremove) as Buttom
